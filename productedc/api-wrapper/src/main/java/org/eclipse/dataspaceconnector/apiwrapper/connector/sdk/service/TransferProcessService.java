...
public class TransferProcessService {
    ...
    public String initiateHttpProxyTransferProcess(String agreementId, String assetId, String consumerControlPlane, String providerConnectorControlPlaneIDSUrl, String receiverHttpEndpoint, Map<String, String> headers) {
        ...
        DataRequest dataRequest = DataRequest.Builder.newInstance()
                ...
                .properties(Map.of("receiver.http.endpoint", receiverHttpEndpoint))
                .build();
