...
public class ApiWrapperExtension implements ServiceExtension {
    ...
    private ApiWrapperConfig createApiWrapperConfig(Config config) {
        ...
        var receiverHttpEndpoint = config.getString(ApiWrapperConfigKeys.RECEIVER_HTTP_ENDPOINT, null);
        if (receiverHttpEndpoint != null) {
            builder.receiverHttpEndpoint(receiverHttpEndpoint);
        }
