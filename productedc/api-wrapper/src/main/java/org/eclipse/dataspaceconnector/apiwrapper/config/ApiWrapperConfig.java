...
public class ApiWrapperConfig {
    ...
    public ApiWrapperConfig(String consumerEDCUrl, String consumerEdcApiKeyName, String consumerEdcApiKeyValue, String authApiKeyName, String authApiKeyValue, Map<String, String> basicAuthUsers, List<String> fixNotNullFields, int endpointDataReferenceCacheTimeInMinutes, String receiverHttpEndpoint) {
    ...
    public static final class Builder {
        ...
        private String receiverHttpEndpoint = null;
        ...
        public Builder receiverHttpEndpoint(String endpoint) {
            this.receiverHttpEndpoint = endpoint;
            return this;
        }

        public ApiWrapperConfig build() {
            return new ApiWrapperConfig(consumerEdcUrl, consumerEdcApiKeyName, consumerEdcApiKeyValue, authApiKeyName, authApiKeyValue, basicAuthUsers, fixNotNullFields, endpointDataReferenceCacheTimeInMinutes, receiverHttpEndpoint);
        }
    }
}
